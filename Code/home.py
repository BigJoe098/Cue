...
class home_screen(QMainWindow):
    def __init__(self,ui_file):
        ...
        #notify Timer
        notify_timer= QtCore.QTimer(self)
        notify_timer.timeout.connect(self.notify_check)
        notify_timer.start(1000)
    ...
    #Function to check if notification needs to be displayed
    def notify_check(self):
        ...
        for i in data:
            ...
            schedule_hm=i[2][11:16]
            if current_hm==schedule_hm:
                toaster = ToastNotifier()
                toaster.show_toast(i[1],i[4])
...
class vedit_schedule(QMainWindow):
    ...
    def search_schedules(self):
        ...
        is_search=True
        self.generate_schedule(is_search,search_text,to_date,from_date)
...
if __name__ == "__main__":
    ...
    app.setApplicationDisplayName('Cue')
